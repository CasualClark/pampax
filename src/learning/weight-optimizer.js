 ...
 * based on satisfaction signals, improving retrieval performance over time.
 */
export class WeightOptimizer {
   ...
   */
  async optimizeWeights(signals, currentWeights, options = {}) {
   ...
   */
  async applyWeightUpdates(weights) {
    try {
   ...
   */
  async rollbackWeights(rollbackData) {
    try {
   ...
   */
  calculateGradients(signals, weights, validIntents) {
    const gradients = {};
   ...
   */
  applyWeightUpdatesInternal(weights, gradients, options) {
    const newWeights = {};
   ...
   */
  calculateLoss(signals, weights, validIntents) {
   ...
   */
  calculateOverallSatisfaction(signals) {
   ...
   */
  predictSatisfaction(weightContribution) {
