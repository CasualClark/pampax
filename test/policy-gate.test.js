...
describe('Policy Gate Tests', () => {
  ...
  test('should evaluate API intent policy correctly', () => {
    ...
    assert.ok(policy.maxDepth >= 2, 'API intent should have maxDepth of at least 2');
    ...
    assert.ok(policy.earlyStopThreshold >= 2, 'API intent should have earlyStopThreshold of at least 2');
  ...
  test('should evaluate incident intent policy correctly', () => {
    ...
    assert.ok(policy.maxDepth >= 3, 'Incident intent should have maxDepth of at least 3');
    ...
    assert.ok(policy.earlyStopThreshold >= 5, 'Incident intent should have earlyStopThreshold of at least 5');
